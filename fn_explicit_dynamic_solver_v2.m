function [history_output, field_output] = fn_explicit_dynamic_solver(K, M, global_matrix_nodes, global_matrix_dofs, time, forcing_indices, forcing_functions, history_indices, field_output_every_n_frames, use_diagonal_lumped_mass_matrix, varargin)
%SUMMARY
